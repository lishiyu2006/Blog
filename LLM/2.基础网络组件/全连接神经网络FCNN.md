...
计算均方误差使用的是MSELoss类，也称为平方 L 2 L_2L 
2
​
...
从零开始和简洁实现是完全等价的。
————————————————
版权声明：本文为CSDN博主「三耳01」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/niexinyu0026/article/details/121345552