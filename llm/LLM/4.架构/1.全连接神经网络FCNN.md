...
### 2、激活函数
这里是**复指数函数**,可以简化为 $(f(z) = e^z)$。
不完全是常用的激活函数,详情见[激活函数]([激活函数 | 下午好](https://lishiyu2006.github.io/Blog/LLM/4.%E6%9E%B6%E6%9E%84/%E6%BF%80%E6%B4%BB%E5%87%BD%E6%95%B0.html))
### 3.常规问题
